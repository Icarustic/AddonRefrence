...
public class EntityScalableProjectile extends ElementsAgeofshinobiaddonMod.ModElement {
    public EntityScalableProjectile(ElementsAgeofshinobiaddonMod instance) {
        super(instance, 520);
    }
